...
const clickHanlder = (event) => {
  ...
  // remove the acitve class from previously active job item - inace baca error prilikom inicijaliziranja
  //   const active = document.querySelector(".job-item--active");
  //   if (active) {
  //     active.classList.remove("job-item--active");
  //   }
